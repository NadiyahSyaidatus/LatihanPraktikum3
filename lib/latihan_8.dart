      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: Color.fromARGB(
              255, 80, 182, 255), // Ganti warna appbar menjadi hijau
        ),
        body: ProfilePage(),
      ),
    );
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Image.network(
              ...
              height: 100,
              fit: BoxFit
                  .cover, // Untuk mengatur bagaimana gambar ditampilkan dalam kotak
            ),
          ),
        ),
        Positioned(
        ...
        Positioned(
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: Color.fromARGB(
                  255, 80, 182, 255), // Mengubah warna latar belakang tombol
              shape: RoundedRectangleBorder(
                borderRadius:
                    BorderRadius.circular(8.0), // Mengatur border radius tombol
              ),
            ),
          ),
        ),
